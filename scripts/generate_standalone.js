    ...
    <div class="page-container">
        ...
        <div class="bg-white rounded-xl shadow-lg p-4 mb-6">
            <div class="flex flex-wrap gap-4 items-center justify-between">
                ...
                <div class="flex gap-2">
                    <a href="knowledge_${key}.html?semester=upper" class="btn ${'{{'}}'btn ${'{{'}}'btn === 'upper' ? 'btn-primary' : 'btn-gray'}}">上册</a>
                    <a href="knowledge_${key}.html?semester=lower" class="btn ${'{{'}}'btn ${'{{'}}'btn === 'lower' ? 'btn-primary' : 'btn-gray'}}">下册</a>
                </div>
